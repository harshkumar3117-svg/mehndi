...
const SERVICES = [
  {
    ...
    num: '01',
    title: 'Bridal Mehndi',
    desc: 'Customized premium intricate designs for your special day. Full hand & arm coverage with figure work, portraits, and your unique love story woven into every pattern. Packages from ₹4,000 to ₹15,000.',
  ...
  },
  {
    icon: '💐',
    num: '02',
    title: 'Normal & Family Mehndi',
    desc: 'Beautiful, elegant designs for bridesmaids, family members, and guests. Various price tiers from ₹300 to ₹2,000 — stunning patterns for every budget.',
    btn: 'View Normal Mehndi Prices',
    id: 'pricing',
  },
  {
    icon: '🎓',
